...
async function main() {
    ...
    try {
        ...
        const products = productsData.map((data) => new Product_1.Product(data.id, data.title, data.description, data.category, data.price, data.discountPercentage, data.rating, data.stock, data.brand));
